...
cd $PREFIX/Software
echo "================================================================================================================================================================================================="
echo "Type ./Hairpindex_installer.install and Press enter" 
echo "Just click NEXT option for path /usr/local/MATLAB/MATLAB_Runtime/v98"
echo "Click exit if it dosen't processd after installing"
echo "If it ask again for installation cancel the installation it will proccesed for next installation"
echo "=================================================================================================================================================================================================="
